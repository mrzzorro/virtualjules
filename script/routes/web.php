...
Route::get('/front/photos','FrontPhotoController@index')->name('frontphoto')->middleware('two_factor');
Route::get('/popupmodel','FrontPhotoController@popup')->name('popupmodel')->middleware('two_factor');
Route::post('/photocomment','FrontPhotoController@photoCommentStore')->name('photocomment')->middleware('two_factor');
Route::get('/likephoto','FrontPhotoController@like')->name('likephoto')->middleware('two_factor');
Route::get('/comment_like_photo','FrontPhotoController@comment_like')->name('comment_like_photo');
Route::get('/ellipsisphoto','FrontPhotoController@ellipsis')->name('ellipsisphoto')->middleware('two_factor');
Route::post('/report/photo','FrontPhotoController@report')->name('report_photo')->middleware('two_factor');
Route::get('/report/photo/show','FrontPhotoController@show')->name('report.photo.show')->middleware('two_factor');
...
Route::get('photo/{slug}', 'PhotoController@show')->name('photo.show');
...
Route::get('latest-photos', 'PhotoController@latest')->name('photos.latest');
Route::get('trending-photos', 'PhotoController@trending')->name('photos.trending');
...
Route::group(['as'=>'admin.','prefix'=>'admin','namespace'=>'Admin','middleware'=>['admin','auth']],function(){
	...
	Route::get('videos/{id}/toggle-approval', 'VideoController@toggleApproval')->name('videos.toggleApproval');
	...
	// New Admin Photo Routes
	Route::get('photos/manage', '\App\Http\Controllers\PhotoController@manage')->name('photos.manage');
	Route::get('photos/{id}/edit', '\App\Http\Controllers\PhotoController@edit')->name('photos.edit');
	Route::post('photos/{id}/update', '\App\Http\Controllers\PhotoController@update')->name('photos.update');
	Route::get('photos/{id}/toggle-approval', '\App\Http\Controllers\PhotoController@toggleApproval')->name('photos.toggleApproval');
	Route::get('photos/{id}/destroy', '\App\Http\Controllers\PhotoController@destroy')->name('photos.destroy');
