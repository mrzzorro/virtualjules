  ...
  <aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="nav-item dropdown {{ Request::is('admin/video*') ? 'active' : '' }}">
        ...
        <ul class="dropdown-menu">
          <li><a class="nav-link {{ Request::is('admin/videos/manage') ? 'active' : '' }}" href="{{ route('admin.videos.manage') }}">{{ __('Manage Videos') }}</a></li>
          <li><a class="nav-link {{ Request::is('admin/video/report') ? 'active' : '' }}" href="{{ route('admin.video.report') }}">{{ __('Manage Reports') }}</a></li>
        </ul>
      </li>
      <li class="nav-item dropdown {{ Request::is('admin/photos*') ? 'active' : '' }}">
        <a href="#" class="nav-link has-dropdown"><i class="far fa-image"></i> <span>{{ __('Photos') }}</span></a>
        <ul class="dropdown-menu">
          <li><a class="nav-link {{ Request::is('admin/photos/manage') ? 'active' : '' }}" href="{{ route('admin.photos.manage') }}">{{ __('Manage Photos') }}</a></li>
        </ul>
      </li>
