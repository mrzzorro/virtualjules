                ...
                <div class="col-lg-3">
                    <div class="header-right-section f-right">
                        ...
                        <div class="upload-btn">
                            @if(Session::has('mode'))
                            @if(Session::get('mode')['id'] == 'night')
                            <a class="pjax" href="{{ route('frontphoto') }}"><img id="photo_mode" class="home" src="{{ asset('frontend/img/photo.png') }}" alt=""></a>
                            @else
                            <a class="pjax" href="{{ route('frontphoto') }}"><img id="photo_mode" class="home" src="{{ asset('frontend/img/photo.png') }}" alt=""></a>
                            @endif
                            @else
                        ...
                        <div class="profile-seeting">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <div class="dropdown-border">
                                    ...
                                    <a href="{{ route('photos.latest') }}" class="pjax dropdown-item">{{ __('Photos') }}</a>
