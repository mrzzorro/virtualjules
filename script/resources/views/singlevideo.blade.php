									...
									<div class="video-empty">
										<div class="video-section">
                                            @if($video->video_type == 'url')
                                                {!! App\Helpers\VideoHelper::getEmbedCode($video->url) !!}
                                            @else
									...
									<div class="single_video">
										<div class="modal-right-section">
                                            ...
                                            <div class="video-details mt-3">
                                                ...
                                                @endif
                                                @if($video->cta_label && $video->cta_url)
                                                    <a href="{{ $video->cta_url }}" class="btn btn-primary" target="_blank">{{ $video->cta_label }}</a>
                                                @endif
                                            </div>
