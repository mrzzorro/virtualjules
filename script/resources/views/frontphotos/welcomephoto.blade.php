                ...
                <div class="col-lg-9">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="main-area-title">
                                <h2>{{ __('Trending') }}</h2>
                                <p>{{ __('Watch the latest photos from our community') }}</p>
                            </div>
                        </div>
                    </div>
                    @csrf
                    <div class="row">
                        @foreach($photos as $photo)
                            @include('frontphotos.singlephoto')
                        @endforeach
                    </div>
...
<input type="hidden" id="popup_photo_url" value="{{ route('popupmodel') }}">
<input type="hidden" id="ellipsis_url" value="{{ route('ellipsisphoto') }}">
