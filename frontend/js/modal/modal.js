...
function ellipsis_photo_open(id)
{ 
    ellipsisPhoto(id);
    $('.ellipish-modal').removeClass('d-none');
}
...
{
    var baseurl = $('#base_url').val();
    var photo_url = baseurl+'/photo/'+id;
    $('.ellipish-modal').removeClass('d-none');
    // alert(photo_url);
    $('.ellipish-list').html('<div class="share-header"><h4>Share</h4><div class="single-share"><a target="_blank" href="https://www.facebook.com/dialog/share?app_id=87741124305&href='+photo_url+'%3Fv%3DRCEKC6wpj6M%26feature%3Dshare&display=popup"><i class="fab fa-facebook"></i><span>Share to Facebook</span></a></div><div class="single-share"><a target="__blank" href="https://pinterest.com/pin/create/button/?url='+photo_url+'"><i class="fab fa-pinterest"></i><span>Share to Pinterest</span></a></div><div class="single-share"><a target="__blank" href="https://twitter.com/intent/tweet?url='+photo_url+'&text='+id+'"><i class="fab fa-twitter-square"></i><span>Share to Twitter</span></a></div><div class="single-share"><a target="__blank" href="mailto:?subject='+id+'&amp;body=Check out this site '+photo_url+'."><i class="far fa-envelope"></i><span>Share via Email</span></a></div><div class="single-share"><a href="javascript:void(0)" onclick="copy_link()"><i class="fas fa-link"></i><span>Copy Link</span></a></div><div class="single-share"><a href="javascript:void(0)" onclick="cancel_ellipish()"><i class="far fa-times-circle"></i><span>Cancel</span></a></div></div>');
}
